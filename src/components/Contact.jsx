...
const Contact = () => {
  ...
  return (
    <div name="contact" className="w-full h-screen bg-[#0D1F3C] flex justify-center items-center p-4 text-center ">
      <form name="contactv1" method="post" data-netlify="true" onSubmit={handleSubmit} className="flex flex-col max-w-[1200px] w-full shadow-md shadow-[#040c16] p-4 md:text-left mt-20 text-center animation" data-aos="fade-up">
